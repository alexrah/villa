...
<style type="text/css">
#gkBreadcrumb {
	<?php if($this->API->get('breadcrumb_image', '') != '') : ?>
	background-image: url('<?php echo JURI::root() . $this->API->get('breadcrumb_image', ''); ?>');
	<?php endif; ?>
	background-position: 50% 20%;
	background-size: cover; 
	background-color: <?php echo $this->API->get('breadcrumb_image', '#7484ff'); ?>;
}
</style>
