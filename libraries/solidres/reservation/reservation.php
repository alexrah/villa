...
class SRReservation
{
	...
	public function storeRoom($reservationId, $room)
	{
		...
		$values = (int) $reservationId . ',' .
			...
			$this->_dbo->quote($room['room_price_tax_incl']) . ',' .
			$this->_dbo->quote($room['room_price_tax_excl']);
	...
	public function isCheckInCheckOutValid($checkIn, $checkOut, $conditions)
	{
		...
		if ($conditions['min_length_of_stay'] > 0)
		{
			...
			{
				throw new Exception('SR_ERROR_INVALID_MIN_LENGTH_OF_STAY', 50002);
			}
		}
