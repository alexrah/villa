		...
		<div id="sr_panel_right" class="sr_list_view span10">
			...
			$saveOrder	= $listOrder == 'r.ordering';
				if ($saveOrder):
					...
					SRHtml::_('jquery.sortable', 'facilityList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
				endif;
			?>
			<form action="<?php echo JRoute::_('index.php?option=com_solidres&view=facilities'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<table class="table table-striped" id="facilityList">
					<thead>
						<tr>
							...
							<th class="title">
								<?php echo JHtml::_('grid.sort',  'SR_HEADING_SCOPE', 'r.scope_id', $listDirn, $listOrder); ?>
							</th>
							<th>
