    ...
    <div class="row-fluid">
		...
		<div id="sr_panel_right" class="sr_list_view span10">
			<form action="<?php echo JRoute::_('index.php?option=com_solidres&view=reservations'); ?>" method="post" name="adminForm" id="adminForm">
				<button type="submit" class="btn btn-info"><i class="icon-search"></i> Submit</button>
				<a id="reservation-filter-clear" href="<?php echo JRoute::_('index.php?option=com_solidres&view=reservations&filter_clear=1') ?>"
				   class="btn"><i class="icon-remove"></i> Clear</a>
				...
				<table class="table table-striped">
					<thead>
		                ...
		                <tr class="filter-row">
							...
							<th>
								<select name="filter_payment_status" class="inputbox span12">
