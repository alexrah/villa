ALTER TABLE `#__sr_extras` ADD `mandatory` TINYINT(3) UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE `#__sr_extras` ADD `charge_type` TINYINT(3) UNSIGNED NOT NULL DEFAULT 0;
DROP TABLE `#__sr_prices`;
...
ALTER TABLE  `#__sr_room_types` ADD  `smoking` TINYINT( 2 ) NOT NULL DEFAULT  '0';

ALTER TABLE  `#__sr_reservations` ADD  `customer_title` VARCHAR( 45 ) NULL;
...
ALTER TABLE `#__sr_reservations` ADD `payment_method_txn_id` VARCHAR( 255 ) NULL DEFAULT NULL AFTER `payment_method_id`;
ALTER TABLE `#__sr_reservations` ADD `payment_status` TINYINT( 2 ) NULL DEFAULT '0' AFTER `payment_method_txn_id`;
-- -----------------------------------------------------
