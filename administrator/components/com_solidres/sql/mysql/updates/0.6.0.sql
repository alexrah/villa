ALTER TABLE  `#__sr_reservations` ADD  `deposit_amount` DECIMAL( 12, 2 ) UNSIGNED NULL DEFAULT NULL;
...
ALTER TABLE `#__sr_room_types` CHANGE COLUMN `ordering` `ordering` INT(11) NOT NULL DEFAULT 0 ;
...
ALTER TABLE  `#__sr_currencies` ADD  `filter_range` VARCHAR( 255 ) NOT NULL ;
