...
ALTER TABLE  `#__sr_extras` ADD  `params` TEXT NOT NULL ;

ALTER TABLE  `#__sr_coupons` ADD  `params` TEXT NOT NULL ;

ALTER TABLE  `#__sr_customers` ADD  `vat_number` VARCHAR( 255 ) NOT NULL ;

ALTER TABLE  `#__sr_reservations` ADD  `customer_vat_number` VARCHAR( 255 ) NULL DEFAULT NULL AFTER  `customer_geo_state_id` ;
...
ALTER TABLE `#__sr_reservation_room_xref`
  ADD `room_price_tax_incl` DECIMAL( 12, 2 ) UNSIGNED NULL AFTER  `room_price` ,
  ADD `room_price_tax_excl` DECIMAL( 12, 2 ) UNSIGNED NULL AFTER  `room_price_tax_incl` ;

ALTER TABLE `#__sr_reservation_room_xref`
  CHANGE `room_price` `room_price` DECIMAL( 12, 2 ) UNSIGNED NULL DEFAULT NULL ;